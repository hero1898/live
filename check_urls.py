...
def read_txt_file(file_path):
    skip_strings = ['#genre#', '127.0.0.1', '192.168', '198.168', 'php.jdshipin', '[240', 'ottrrs.hl.chinamobile', '/live/0701', 'ChiSheng9', 'epg.pw', '/hls/', '(576p)', '(540p)', '(360p)', '(480p)', '(180p)', '(404p)', 'r.jdshipin', 'ali.hlspull.yximgs', 'generationnexxxt', 'live.goodiptv.club', 'playtv-live.ifeng']  # 定义需要跳过的字符串数组['#', '@', '#genre#'] 
...
if __name__ == "__main__":
	...
	'https://raw.bgithub.xyz/balala2oo8/iptv/main/o.m3u',
	...
	'https://raw.bgithub.xyz/Guovin/TV/gd/result.txt',
        ...
        'https://raw.bgithub.xyz/LuckyLearning/myTV/6b3cb61977fe3b3ab25383e2852d001a963e6771/result.txt',
        'https://raw.bgithub.xyz/frxz751113/AAAAA/main/TW.txt',
...
凤凰中文,http://wouu.net:9977/udp/239.93.0.162:219
